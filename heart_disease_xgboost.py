...
div[data-testid="stButton"] > button {
    background: linear-gradient(135deg, #9b0030, #c1121f) !important;
    color: white !important;
    ...
    width: 100% !important;
    box-shadow: 0 4px 20px rgba(155,0,48,0.4) !important;
}
div[data-testid="stButton"] > button:hover {
    transform: translateY(-2px) !important;
}
.res-high {
    background: linear-gradient(135deg,#7b0020,#c1121f) !important;
    border-radius: 20px !important; padding: 40px !important;
    text-align: center !important; color: white !important;
    box-shadow: 0 12px 40px rgba(155,0,48,0.4) !important;
...
.res-low {
    ...
    border-radius: 20px !important; padding: 40px !important;
    text-align: center !important; color: white !important;
    box-shadow: 0 12px 40px rgba(21,128,61,0.38) !important;
    margin: 20px 0 !important;
}
...
.foot {background:#1a1a2e; color:rgba(255,255,255,0.3); text-align:center; padding:24px; font-size:0.76rem; margin-top:60px;}
</style>
...
if predict:
    ...
    if any(s=="Select" for s in selects) or any(v==0 for v in nums):
        ...
        st.markdown('<p style="font-size:0.74rem;color:#9ca3af;text-align:center;margin-top:10px;">⚕️ For educational use only. Always consult a medical professional.</p>', unsafe_allow_html=True)
